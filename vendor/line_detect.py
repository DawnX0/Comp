...
from .hsv_color_ranges import HSVColorRanges
...
def process_frame_for_line(
    ...
    min_contour_area: int = 300,  # Minimum area threshold for valid line contours
    max_contour_area: int = 10000000,  # Maximum area threshold for valid line contours
):
    ...
    if line_contour is not None:
        ...
        # Filter contours based on both minimum and maximum area
        if contour_area < min_contour_area:
            return DotDict({"line_center": None, "robot_view": resized_frame, "rectangle_dimensions": None, "angle": None})
